...
const tableInnerDefaultMergeList = (data, newData) => {
  return Object.assign({}, newData, {
    pageData: (data.pageData || []).concat(newData.pageData || []),
  });
};
const tableInnerDefaultDataFormat = (data) => {
  return {
    list: data.pageData,
...
const TableInner = withFetch(
  ({
    mergeList = tableInnerDefaultMergeList,
    dataFormat = tableInnerDefaultDataFormat,
    ...props
  }) => {
...
const TableInputField = ({ api = {}, value = {}, ...props }) => {
  return <TableInner value={value} {...props} {...api} />;
};
